...
export class CompteComponent implements OnInit {
  ...
  trackId(_index: number, item: ICompte): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICompte[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
