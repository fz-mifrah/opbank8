...
export class RechargeComponent implements OnInit {
  ...
  constructor(protected rechargeService: RechargeService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.recharges = [];
    ...
    this.rechargeService
      ...
      .subscribe({
        next: (res: HttpResponse<IRecharge[]>) => {
          ...
          this.paginateRecharges(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateRecharges(data: IRecharge[] | null, headers: HttpHeaders): void {
