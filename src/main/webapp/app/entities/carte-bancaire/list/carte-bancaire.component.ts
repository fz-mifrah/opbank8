...
export class CarteBancaireComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.carteBancaireService
      ...
      .subscribe({
        next: (res: HttpResponse<ICarteBancaire[]>) => {
  ...
  trackId(_index: number, item: ICarteBancaire): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICarteBancaire[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
