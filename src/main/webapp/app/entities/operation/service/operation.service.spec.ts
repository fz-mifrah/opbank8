...
describe('Operation Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      numOperation: 'AAAAAAA',
      date: currentDate,
      typeOperatin: TypeOperation.TypeVirement,
      etatOperation: EtatOperation.Cree,
      montant: 0,
    };
  });
  ...
  describe('Service methods', () => {
    ...
    describe('addOperationToCollectionIfMissing', () => {
      ...
      it('should add only unique Operation to an array', () => {
        const operationArray: IOperation[] = [{ id: 123 }, { id: 456 }, { id: 42458 }];
